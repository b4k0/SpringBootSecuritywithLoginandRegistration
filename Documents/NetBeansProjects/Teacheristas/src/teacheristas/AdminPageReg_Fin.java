...
public class AdminPageReg_Fin extends javax.swing.JFrame {

    /**
     * Creates new form HomePage
     */
    public AdminPageReg_Fin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teacheristas/AdminPageReg_Fin.jpg"))); // NOI18N
        jLabel1.setText(" ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminPageReg_Fin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminPageReg_Fin().setVisible(true);
            }
        });
    }
