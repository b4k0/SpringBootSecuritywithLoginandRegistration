...
public class TeacherPageReg_Fin extends javax.swing.JFrame {

    /**
     * Creates new form HomePage
     */
    public TeacherPageReg_Fin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teacheristas/TeacherPageReg_Fin.jpg"))); // NOI18N
        jLabel1.setText(" ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherPageReg_Fin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherPageReg_Fin().setVisible(true);
            }
        });
    }
