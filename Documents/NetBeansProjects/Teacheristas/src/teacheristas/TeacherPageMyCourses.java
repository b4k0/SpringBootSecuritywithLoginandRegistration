...
public class TeacherPageMyCourses extends javax.swing.JFrame {

    /**
     * Creates new form HomePage
     */
    public TeacherPageMyCourses() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teacheristas/TeacherPageMyCourses.jpg"))); // NOI18N
        jLabel1.setText(" ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherPageMyCourses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherPageMyCourses().setVisible(true);
            }
        });
    }
