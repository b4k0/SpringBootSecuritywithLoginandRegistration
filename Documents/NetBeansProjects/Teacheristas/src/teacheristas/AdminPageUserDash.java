...
public class AdminPageUserDash extends javax.swing.JFrame {

    /**
     * Creates new form HomePage
     */
    public AdminPageUserDash() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 30, 70, 30));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teacheristas/AdminPageUserDash.jpg"))); // NOI18N
        jLabel1.setText(" ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminPageUserDash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminPageUserDash().setVisible(true);
            }
        });
    }
