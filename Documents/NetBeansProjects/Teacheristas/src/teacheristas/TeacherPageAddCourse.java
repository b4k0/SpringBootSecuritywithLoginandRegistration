...
public class TeacherPageAddCourse extends javax.swing.JFrame {

    /**
     * Creates new form HomePage
     */
    public TeacherPageAddCourse() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teacheristas/TeacherPageAddCourse.jpg"))); // NOI18N
        jLabel1.setText(" ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherPageAddCourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherPageAddCourse().setVisible(true);
            }
        });
    }
